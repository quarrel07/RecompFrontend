...
static std::unordered_map<SDL_Scancode, std::string> scancode_codepoints{
    ...
    // promptfont has no fullwidth "keycap" glyphs for punctuation, only plain ASCII ones.
    {SDL_SCANCODE_MINUS, PF_ASCII_DASH},
    {SDL_SCANCODE_EQUALS, PF_ASCII_EQUALS},
    {SDL_SCANCODE_LEFTBRACKET, PF_ASCII_OPEN_BRACKET},
    {SDL_SCANCODE_RIGHTBRACKET, PF_ASCII_CLOSE_BRACKET},
    {SDL_SCANCODE_BACKSLASH, PF_ASCII_BACKSLASH},
    {SDL_SCANCODE_SEMICOLON, PF_ASCII_SEMICOLON},
    {SDL_SCANCODE_APOSTROPHE, PF_ASCII_QUOTE},
    {SDL_SCANCODE_GRAVE, PF_ASCII_BACKTICK},
    {SDL_SCANCODE_COMMA, PF_ASCII_COMMA},
    {SDL_SCANCODE_PERIOD, PF_ASCII_PERIOD},
    {SDL_SCANCODE_SLASH, PF_ASCII_SLASH},
